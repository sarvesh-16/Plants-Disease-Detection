...
class TCarouselSlider extends StatefulWidget {
  ...
  @override
  _TCarouselSliderState createState() => _TCarouselSliderState();
}

class _TCarouselSliderState extends State<TCarouselSlider> with TickerProviderStateMixin {
  Timer timer;
